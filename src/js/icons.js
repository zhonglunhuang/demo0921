/* icons.js — window.Icons：內嵌線條 SVG 圖示（24px 網格、stroke 1.5px、currentColor）。
 * 用法：Icons.get('bell')            → 24px SVG 字串
 *       Icons.get('bell', { size: 18, className: 'x', label: '通知' })
 * 找不到名稱時回傳一個圓點，不回傳 undefined。全站禁止用 emoji 當圖示。 */
(function () {
  'use strict';
  ...
  var PATHS = {
    ...
    'building': '<rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M9.5 21v-4h5v4"/><path d="M8 7.5h2M14 7.5h2M8 11.5h2M14 11.5h2M8 15.5h2M14 15.5h2"/>',
    'door': '<path d="M4 21V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16"/><path d="M2 21h20"/><path d="M15 12h.01"/>',
    ...
    'bot': '<rect x="4" y="8" width="16" height="12" rx="3"/><path d="M12 8V5"/><circle cx="12" cy="4" r="1"/><path d="M9 14h.01"/><path d="M15 14h.01"/><path d="M9.5 17.5h5"/><path d="M2 13v3"/><path d="M22 13v3"/>',
    'sparkles': '<path d="M12 3v3"/><path d="M12 18v3"/><path d="M3 12h3"/><path d="M18 12h3"/><path d="m12 7 1.5 3.5L17 12l-3.5 1.5L12 17l-1.5-3.5L7 12l3.5-1.5z"/><path d="M5 5l1 1"/><path d="M18 18l1 1"/>',

    // 租務與資產
    'key': '<circle cx="7.5" cy="15.5" r="4.5"/><path d="m10.8 12.2 10.2-10.2"/><path d="m18 5 3 3"/><path d="m14.5 8.5 2.5 2.5"/>',
    'wrench': '<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>',
    'droplet': '<path d="m12 2.7 5.66 5.66a8 8 0 1 1-11.32 0z"/>',
    ...
    'tag': '<path d="m20.6 13.4-7.2 7.2a2 2 0 0 1-2.8 0L2 12V2h10l8.6 8.6a2 2 0 0 1 0 2.8z"/><path d="M7 7h.01"/>',
    ...
    'wallet': '<path d="M20 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2z"/><path d="M16 3H6a2 2 0 0 0-2 2v2"/><path d="M17 14h.01"/>',
    'receipt': '<path d="M4 2v20l3-2 3 2 2-2 2 2 3-2 3 2V2l-3 2-3-2-2 2-2-2-3 2z"/><path d="M8 8h8"/><path d="M8 12h8"/><path d="M8 16h5"/>',
    ...
    'trend-down': '<path d="m23 18-9.5-9.5-5 5L1 6"/><path d="M17 18h6v-6"/>',
    ...
    'doc': '<path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><path d="M13 2v7h7"/><path d="M16 13H8"/><path d="M16 17H8"/><path d="M10 9H8"/>',
    'file-plus': '<path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"/><path d="M13 2v7h7"/><path d="M12 18v-6"/><path d="M9 15h6"/>',
  ...
  function get(name, opts) {
    ...
    var cls = 'icon icon--' + (PATHS[key] ? key : 'dot') + (opts.className ? ' ' + opts.className : '');
    var a11y = opts.label
      ? ' role="img" aria-label="' + esc(opts.label) + '"'
      : ' aria-hidden="true"';
    return '<svg class="' + cls + '" width="' + size + '" height="' + size + '" viewBox="0 0 24 24" fill="none" ' +
      'stroke="currentColor" stroke-width="' + (opts.strokeWidth || 1.5) + '" stroke-linecap="round" stroke-linejoin="round"' +
      a11y + ' focusable="false">' + body + '</svg>';
  }

  function has(name) { return Object.prototype.hasOwnProperty.call(PATHS, String(name || '')); }
  function names() { return Object.keys(PATHS); }

  window.Icons = { get: get, has: has, names: names };
})();
